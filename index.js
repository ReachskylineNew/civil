// ===================================
// REVOLUTIONARY CIVIL ENGINEERING LANDING PAGE
...
console.log('🏗️ Department of Civil Engineering - Revolutionary Design Loaded');
console.log('✨ Features: Diagonal Hero, Circular Stats, Infrastructure Focus, Timeline, Wizard Form');
console.log('📧 Contact: hodcivil@kanchiuniv.ac.in');
console.log('📞 Phone: +91 44 2747 2005');

// ===================================
// ALUMNI SECTION (Static Center)
// ===================================
// Carousel logic removed as requested for limited items.
